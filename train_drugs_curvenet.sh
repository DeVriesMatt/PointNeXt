...
poolings=("additive" "attention" "conjunctive" "instance" "gap")  # Replace with actual pooling options

# Original YAML file
config_file="cfgs/modelnet40ply2048/curvenet_mil.yaml"
...
for pooling in "${poolings[@]}"; do
  for choice in "${choices[@]}"; do
    ...
    modified_config="${output_dir}/curvenet_mil_final_drugs_${choice}_pooling_${pooling}.yaml"
    ...
    run_log="${output_dir}/curvenet_mil_final_drugs_noc_blebb_run_choice_${choice}_pooling_${pooling}.log"
