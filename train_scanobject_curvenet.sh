...
# Original YAML file
config_file="cfgs/scanobjectnn/curvenet_mil.yaml"
...
for pooling in "${poolings[@]}"; do
  for choice in "${choices[@]}"; do
    ...
    modified_config="${output_dir}/curvenet_mil_final_scanobjectnn_${choice}_pooling_${pooling}.yaml"
    ...
    run_log="${output_dir}/curvenet_mil_scanobjectnn_${choice}_pooling_${pooling}.log"
