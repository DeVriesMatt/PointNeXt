...
# Original YAML file
config_file="cfgs/modelnet40ply2048/pointmil_pointmlpelite_drugs.yaml"
...
for pooling in "${poolings[@]}"; do
  for choice in "${choices[@]}"; do
    ...
    modified_config="${output_dir}/pointmlp_mil_final_drugs_${choice}_pooling_${pooling}.yaml"
    ...
    run_log="${output_dir}/pointmlp_mil_final_drugs_noc_blebb_run_choice_${choice}_pooling_${pooling}.log"
